...
class EmployeeService
{
    ...
    public function getEmployee($request)
    {
        return [
            ...
            'community_tax_cert_no' => $request->community_tax_cert_no,
            'community_tax_issued_at' => $request->community_tax_issued_at,
            'community_tax_issued_on' => $request->community_tax_issued_on,
        ];
    }
