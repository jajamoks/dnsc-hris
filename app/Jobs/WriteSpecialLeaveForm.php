...
class WriteSpecialLeaveForm extends Job implements SelfHandling
{
    ...
    protected function writeForm($leave)
    {
        ...
        $leave_form = Excel::load($path, function ($reader) use ($leave, $employee, $not_found) {
            ...
            $sheet->setCellValue('A8', $employee->user->department->name); // Staff / Division
