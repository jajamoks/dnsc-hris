...
},{"./transport":15,"./transports":16,"component-emitter":8,"debug":10,"engine.io-parser":22,"indexof":27,"parsejson":32,"parseqs":33,"parseuri":34}],15:[function(require,module,exports){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":9,"debug":10,"engine.io-parser":22,"parseqs":33,"xmlhttprequest-ssl":21,"yeast":74}],20:[function(require,module,exports){
(function (global){
/**
 * Module dependencies.
 */
...
},{"../transport":15,"component-inherit":9,"debug":10,"engine.io-parser":22,"parseqs":33,"ws":6,"yeast":74}],21:[function(require,module,exports){
...
},{"./keys":23,"after":1,"arraybuffer.slice":2,"base64-arraybuffer":4,"blob":5,"has-binary":24,"utf8":48}],23:[function(require,module,exports){
...
},{"spin.js":30}],30:[function(require,module,exports){
/**
...
},{"./manager":37,"./socket":39,"./url":40,"debug":10,"socket.io-parser":43}],37:[function(require,module,exports){
...
},{"./on":38,"./socket":39,"backo2":3,"component-bind":7,"component-emitter":41,"debug":10,"engine.io-client":12,"indexof":27,"socket.io-parser":43}],38:[function(require,module,exports){
...
},{"./on":38,"component-bind":7,"component-emitter":41,"debug":10,"has-binary":25,"socket.io-parser":43,"to-array":46}],40:[function(require,module,exports){
(function (global){
...
},{"./binary":42,"./is-buffer":44,"component-emitter":8,"debug":10,"isarray":28,"json3":45}],44:[function(require,module,exports){
(function (global){
...
},{"../util":72}],50:[function(require,module,exports){
/**
 * Base client.
 */
...
},{"../../promise":65,"../../util":72,"./xhr":53}],51:[function(require,module,exports){
/**
 * JSONP client.
 */
...
},{"../../promise":65,"../../util":72}],52:[function(require,module,exports){
/**
...
},{"../../promise":65,"../../util":72}],53:[function(require,module,exports){
/**
 * XMLHttp client.
 */
...
},{"../../promise":65,"../../util":72}],54:[function(require,module,exports){
/**
 * CORS Interceptor.
 */
...
},{"../util":72,"./client/xdr":52}],55:[function(require,module,exports){
/**
 * Header Interceptor.
 */
...
},{"../promise":65,"../util":72,"./before":49,"./client":50,"./cors":54,"./header":55,"./interceptor":57,"./jsonp":58,"./method":59,"./mime":60,"./timeout":61}],57:[function(require,module,exports){
/**
 * Interceptor factory.
 */
...
},{"../promise":65,"../util":72}],58:[function(require,module,exports){
/**
 * JSONP Interceptor.
 */
...
},{"./client/jsonp":51}],59:[function(require,module,exports){
/**
...
},{"./http":56,"./promise":65,"./resource":66,"./url":67,"./util":72}],63:[function(require,module,exports){
/**
...
},{"./lib/promise":63,"./util":72}],66:[function(require,module,exports){
/**
...
},{"../util":72,"./legacy":68,"./query":69,"./root":70,"./template":71}],68:[function(require,module,exports){
/**
 * Legacy Transform.
 */
...
},{"../lib/url-template":64}],72:[function(require,module,exports){
/**
 * Utility functions.
 */
...
},{"_process":35}],74:[function(require,module,exports){
'use strict';
...
},{"./client":76,"./core/components":102,"./core/directives":103,"./core/filters":104,"ladda":29,"underscore":47,"vue":73,"vue-resource":62}],76:[function(require,module,exports){
'use strict';
...
},{"./config":101,"socket.io-client":36}],77:[function(require,module,exports){
'use strict';
...
Vue.component('hris-activity-logs', {
    ...
    methods: {
        getActivityLogs: function getActivityLogs() {
            this.$http.get('/api/system/logs').then(function (res) {
...
window.EmployeeBirthdays = Vue.extend({
    ...
    methods: {
        getBirthdays: function getBirthdays() {
            this.$http.get('/api/employees/birthdays').success(function (employees) {
...
Vue.component('chat-component', {
    ...
    events: {
        threadsUpdated: function threadsUpdated() {
            this.getMessageThreads();
            // this.getThread(this.messageGroup);
        },
        threadUpdated: function threadUpdated() {
    ...
    methods: {
        updateParticipants: function updateParticipants(messageGroup) {
            this.$http.get('/message-group/' + messageGroup.id + '/edit-participants').success(function (markup) {
                bootbox.dialog({
        ...
        deleteAllMessage: function deleteAllMessage() {
            ...
            swal({
                ...
                that.$http.delete('/message-group/clear-all').success(function (data) {
        ...
        loadThread: function loadThread(messageGroup) {
        ...
        sendNewMessage: function sendNewMessage() {
            this.$http.get('/messages/create').success(function (view) {
                bootbox.dialog({
        ...
        getThread: function getThread(messageGroup) {
            var el = arguments.length <= 1 || arguments[1] === undefined ? null : arguments[1];

            this.$http.get('/api/messages/' + messageGroup.id).success(function (data) {
        ...
        getMessageThreads: function getMessageThreads() {
            this.$http.get('/api/messages').success(function (data) {
                this.threads = data;
            }).error(function () {
                $.niftyNoty({
                    type: 'danger',
        ...
        markAllRead: function markAllRead() {
            this.$http.put('/api/messages').success(function () {
                $.niftyNoty({
                    type: 'dark',
                    icon: 'fa fa-eye',
                    title: 'Messages seen',
        ...
        deleteMessageGroup: function deleteMessageGroup(messageGroup) {
            var self = this;
            swal({
                ...
                self.$http.delete('/message-group/' + messageGroup.id).success(function (data) {
        ...
        renameThread: function renameThread(messageGroup) {
            var self = this;
    ...
    watch: {
        ...
        showParticipantsModal: function showParticipantsModal() {
...
Vue.component('employees-list', {
    ...
    computed: {
        personnelPerformanceRating: function personnelPerformanceRating() {
            return parseFloat(this.personnel_performance.core_function) + parseFloat(this.personnel_performance.strategic_function);
        },
        qceTotalPoints: function qceTotalPoints() {
            return parseFloat(this.employee_qce.instruction) + parseFloat(this.employee_qce.self) + parseFloat(this.employee_qce.supervisor) + parseFloat(this.employee_qce.peers);
        }
    },
    ...
    methods: {
        ...
        employeeLeaveCredits: function employeeLeaveCredits(employee) {
            if (employee) {
        ...
        personnelPerformanceAndEmployeeQCE: function personnelPerformanceAndEmployeeQCE(user) {
            this.user = user;
        ...
        saveEmployeeLeaveCredits: function saveEmployeeLeaveCredits(employee) {
            var vm = this;
            swal({
                title: "Are you sure?",
                ...
                vm.$http.put('/employee/' + employee.id + '/leave-credits', employee).success(function (data) {
                    $.niftyNoty({
                        type: 'dark',
                        icon: 'fa fa-info',
        ...
        savePersonnelPerformance: function savePersonnelPerformance(personnel_performance) {
            if (personnel_performance) {
                ...
                swal({
                    ...
                    vm.$http.post('/personnel-performance/' + vm.employee.id, personnel_performance).success(function (data) {
                        $.niftyNoty({
                            type: 'dark',
                            icon: 'fa fa-info',
        ...
        saveEmployeeQCE: function saveEmployeeQCE(employee_qce) {
            if (employee_qce && this.qceTotalPoints <= 100) {
                this.$http.post('/qce/' + this.user.username, employee_qce).success(function (data) {
                    $.niftyNoty({
                        type: 'dark',
                        icon: 'fa fa-info',
                        message: 'Successfully updated the employee personnel performance.',
        ...
        updateUser: function updateUser(user) {
            this.$http.get('/user/' + user.username + '/edit').success(function (markup) {
                bootbox.dialog({
        ...
        employeeUtility: function employeeUtility(employee) {
            this.showEmployeeUtilityModal = true;
            this.employee = employee;
            this.utility = employee.utility;
        },
        saveEmployeeUtility: function saveEmployeeUtility(employee) {
        ...
        employeeLeaveApprovalHeirarchy: function employeeLeaveApprovalHeirarchy(employee) {
            console.log(JSON.stringify(employee.approval_heirarchy));
            if (employee.approval_heirarchy) {
                this.$http.get('/employee/approval-heirarchy/' + employee.id + '/edit').success(function (data) {
                    bootbox.dialog({
                ...
                this.$http.get('/employee/approval-heirarchy/' + employee.id + '/create').success(function (data) {
                    bootbox.dialog({
...
Vue.component('hris-event-invitations', {
	...
	methods: {
		getInvitations: function getInvitations() {
			this.$http.get('/api/calendar/invitations').then(function (response) {
				this.invitations = response.data;
			});
		},
		going: function going(training) {
...
Vue.component('hris-forms', {
    ...
    methods: {
        getForms: function getForms() {
            this.$http.get('/api/forms').success(function (data) {
                this.forms = data;
            }).error(function () {
                $.niftyNoty({
                    type: 'danger',
        ...
        deleteForm: function deleteForm(index, form) {
            var self = this;
            if (form.restricted) {
                $.niftyNoty({
                    type: 'dark',
                ...
                swal({
                    ...
                    self.$http.delete('/forms/' + form.id).success(function (data) {
...
Vue.component('hris-main', {
    ...
    events: {
        ...
        messagesUpdated: function messagesUpdated() {
            this.$broadcast('messagesUpdated');
        },
        notificationsUpdated: function notificationsUpdated() {
            this.$broadcast('notificationsUpdated');
        },
        positionsUpdated: function positionsUpdated() {
            this.$broadcast('positionsUpdated');
        }
    },

    methods: {
        messageListener: function messageListener() {
            var self = this;
...
},{"../services/notify":109}],88:[function(require,module,exports){
'use strict';
...
window.Navbar = Vue.extend({
    ...
    events: {
        ...
        newNotification: function newNotification(notification) {
    ...
    methods: {
        getMessages: function getMessages() {
            this.$http.get('/api/messages/unread').success(function (data) {
                this.messages = data;
            });
        },
        getNotifications: function getNotifications() {
            this.$http.get('/api/notifications').success(function (response) {
    ...
    methods: {
        ...
        markAllRead: function markAllRead() {
            ...
            swal({
                ...
                that.$http.put('/notifications').success(function (data) {
...
var Notification = Vue.extend({
    ...
    methods: {
        ...
        loadMore: function loadMore() {
            ...
            if (next_page_url) {
                this.$http.get(next_page_url).success(function (response) {
                    this.paginate = response;
...
window.VuePaginator = Vue.extend({
    ...
    methods: {
        ...
        loadMore: function loadMore() {
            ...
            if (next_page_url) {
                var self = this;
                self.$http.get(next_page_url).success(function (response) {
...
},{"./template.html":92}],92:[function(require,module,exports){
...
Vue.component('hris-positions', {
    ...
    methods: {
        ...
        updatePosition: function updatePosition(position) {
            if (position.name) {
                var self = this;
                this.$http.put('/positions/' + position.id, position).success(function (data) {
                    position = data;
                    swal({
        ...
        deletePosition: function deletePosition(position) {
            if (position.users.length) {
                ...
                swal({
                    ...
                    self.$http.delete('/positions/' + position.id + '/delete').success(function (data) {
        ...
        savePosition: function savePosition(position) {
            var self = this;
            this.$http.post('/api/positions', position).success(function (data) {
                swal({
...
Vue.component('hris-recent-employees', {
    ...
    methods: {
        getEmployees: function getEmployees() {
            this.$http.get('/api/employees/recent-employees/').success(function (response) {
                this.paginator = response;
...
Vue.component('hris-show-department', {
    ...
    mixins: [_infiniteScroll2.default],
    ...
    methods: {
        showDepartment: function showDepartment(code) {
            this.$http.get('/api/departments/' + code).success(function (data) {
...
},{"../mixins/infinite-scroll":108}],97:[function(require,module,exports){
'use strict';
...
Vue.component('show-employee', {
    ...
    methods: {
        getEmployeeEvents: function getEmployeeEvents(username) {
            this.$http.get('/employee/' + username + '/trainings').then(function (response) {
                this.trainings = response.data;
                this.showEmployeeEvents = true;
            });
        },
        toggleIncludeInPds: function toggleIncludeInPds(training) {
            this.$http.put('/api/calendar/' + training.id + '/toggle-include-in-pds').success(function (data) {
                training = data;
...
Vue.component('hris-show-training', {
    ...
    methods: {
        getTraining: function getTraining() {
            var self = this;
            this.$http.get('/api/calendar/' + TRAINING_ID).success(function (res) {
        ...
        deleteTraining: function deleteTraining(training) {
            var self = this;
            swal({
                title: "Are you sure?",
                ...
                self.$http.post('/api/calendar/' + training.id).success(function () {
                    swal({
...
Vue.component('hris-todo', {
    ...
    methods: {
        ...
        refreshTodos: function refreshTodos() {
            var el = $('.refresh').niftyOverlay();
            el.niftyOverlay('hide');
            el.niftyOverlay('show');
            this.getTodos(el);
        ...
        getTodos: function getTodos() {
            ...
            this.$http.get('/todos').success(function (todos) {
        ...
        storeTodo: function storeTodo(todo) {
            if (todo.todo) {
                var laddaButton = Ladda.create(document.querySelector('.ladda-button'));
                laddaButton.start();
                this.$http.post('/todos', todo).success(function (data) {
        ...
        updateTodo: function updateTodo(todo) {
            if (todo.todo) {
                var laddaButton = Ladda.create(document.querySelector('.ladda-button'));
                laddaButton.start();
                this.$http.put('/todos/' + todo.id, todo).success(function (data) {
                    this.todos.push(data);
                    $.niftyNoty({
                        type: 'dark',
                        icon: 'fa fa-trash',
        ...
        destroyTodo: function destroyTodo(todo) {
            this.$http.delete('/todo/' + todo.id + '/delete').success(function (data) {
        ...
        destroyAllTodos: function destroyAllTodos() {
            if (this.todos.length) {
                ...
                swal({
                    ...
                    self.$http.delete('/todos/clear').success(function () {
                        self.getTodos();
        ...
        toggleDone: function toggleDone(todo) {
            this.$http.put('/todos/' + todo.id + '/toggle-done').success(function (data) {
                this.todos.$remove(todo);
                this.todos.push(data);
                $.niftyNoty({
                    type: 'dark',
        ...
        initializeTodo: function initializeTodo() {
            this.todo = {
                todo: ''
            };
        }
    ...
    watch: {
        ...
        'filterTodoBy': function filterTodoBy() {
            this.$nextTick(function () {
                $('.nano').nanoScroller();
                $('#todo-list').find('.form-checkbox').niftyCheck();
            });
    ...
    filters: {
        ...
        filterTodo: function filterTodo(todos, value) {
            var self = this;
...
},{"./../components/activity-logs":77,"./../components/birthday":78,"./../components/calendar":80,"./../components/chat":81,"./../components/custom/datatables":82,"./../components/custom/infinite-scroll":83,"./../components/employees":84,"./../components/event-invitations":85,"./../components/forms":86,"./../components/main":87,"./../components/navbar":88,"./../components/notification-list":89,"./../components/notifications":90,"./../components/paginator":91,"./../components/positions":93,"./../components/qce":94,"./../components/recent-employees":95,"./../components/show-department":96,"./../components/show-employee":97,"./../components/show-training":98,"./../components/sidebar":99,"./../components/todo":100}],103:[function(require,module,exports){
'use strict';

require('./../directives/datatable');

},{"./../directives/datatable":105}],104:[function(require,module,exports){
'use strict';

require('./../filters/string');
require('./../filters/dates');

},{"./../filters/dates":106,"./../filters/string":107}],105:[function(require,module,exports){
'use strict';
