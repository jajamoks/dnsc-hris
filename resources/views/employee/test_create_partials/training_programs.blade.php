        ...
        <div id="trainingPrograms" class="form-horizontal parent">
            ...
            <div class="form-group">
                ...
                <div class="form-group col-sm-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="trainings[title][]" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group col-sm-4">
                    <div class="input-group input-daterange">
                        <input type="text" class="form-control" data-date-format="yyyy-mm-dd" data-provide="datepicker" name="trainings[start][]" placeholder="Date started"/>
                        <span class="input-group-addon">to</span>
                        <input type="text" class="form-control" data-date-format="yyyy-mm-dd" data-provide="datepicker" name="trainings[end][]" placeholder="Date ended"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group col-sm-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="trainings[number_of_hours][]" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group col-sm-4">
                    <div class="input-group">
                        <span class="input-group-addon"><i class="fa fa-user"></i></span>
                        <input type="text" class="form-control" name="trainings[sponsored_by][]" />
                    </div>
                </div>
            </div>
            <hr>
            ...
            <div id="trainingPrograms" class="form-horizontal parent">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group col-sm-6">
                        <div class="input-group">
                            <span class="input-group-addon"><i class="fa fa-user"></i></span>
                            <input type="text" class="form-control" name="training_title[]" value="{{ $training_program->title }}"/>
                        </div>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-group col-sm-4">
                        <div class="input-group input-daterange">
                            <input type="text" class="form-control" data-date-format="yyyy-mm-dd" data-provide="datepicker" name="training_start_date[]" placeholder="Date started" value="{{ $training_program->date_from }}"/>
                            <span class="input-group-addon">to</span>
                            <input type="text" class="form-control" data-date-format="yyyy-mm-dd" data-provide="datepicker" name="training_end_date[]" placeholder="Date ended" value="{{ $training_program->date_to }}"/>
                        </div>
                    </div>
                </div>
