            ...
            <div class="form-group">
                ...
                <div class="form-group col-sm-6">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="employee_voluntary_works[organization_name][]"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group col-sm-8">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="employee_voluntary_works[organization_address][]" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group col-sm-4">
                    <div class="input-group input-daterange">
                        <input type="text" class="form-control" data-date-format="yyyy-mm-dd" data-provide="datepicker" name="employee_voluntary_works[date_from][]" placeholder="Date started"/>
                        <span class="input-group-addon">to</span>
                        <input type="text" class="form-control" data-date-format="yyyy-mm-dd" data-provide="datepicker" name="employee_voluntary_works[date_to][]" placeholder="Date ended"/>
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group col-sm-3">
                    <div class="input-group">
                        ...
                        <input type="number" class="form-control" name="employee_voluntary_works[number_of_hours][]" />
                    </div>
                </div>
            </div>
            ...
            <div class="form-group">
                ...
                <div class="form-group col-sm-4">
                    <div class="input-group">
                        ...
                        <input type="text" class="form-control" name="employee_voluntary_works[position][]" />
                    </div>
                </div>
            </div>
        ...
        @foreach ($employee->employee_voluntary_works as $voluntary_work)
            <div id="voluntaryWork" class="form-horizontal parent">
                ...
                <div class="form-group">
                    ...
                    <div class="form-group col-sm-4">
                        <div class="input-group input-daterange">
                            <input type="text" class="form-control" data-date-format="yyyy-mm-dd" data-provide="datepicker" name="voluntary_work_start_date[]" placeholder="Date started" value="{{ $voluntary_work->date_from }}"/>
                            <span class="input-group-addon">to</span>
                            <input type="text" class="form-control" data-date-format="yyyy-mm-dd" data-provide="datepicker" name="voluntary_work_end_date[]" placeholder="Date ended" value="{{ $voluntary_work->date_to }}"/>
                        </div>
                    </div>
                </div>
